...
class Converters {
  ...
  // public calculate(value: number, fromUnit: Metric1DUnits | Imperial1DUnits | TemperatureUnits, toUnit: Metric1DUnits | Imperial1DUnits | TemperatureUnits): number {
